describe("render informationContainer", function () {
  ...
  it("renders content", function (client) {
    informationContainer.waitForElementVisible("@title", 5000)
      ...
      .assert.containsText("@description", "This is a sample controller Petstore controller. You can find out more about Swagger at http://swagger.io or on irc.freenode.net, #swagger. For this sample, you can use the api key special-key to test the authorization filters.")
